  ...
  return (
    <div className="relative min-h-96 flex-1 overflow-hidden bg-black">
      ...
      <div className="pointer-events-none absolute inset-0 grid place-items-center bg-black/20">
        <div className="h-28 w-72 max-w-xs rounded-xl border-2 border-good bg-app/10" />
      </div>
      <div className="absolute bottom-4 left-4 right-4 rounded-lg bg-app/80 p-3 text-center text-sm text-muted backdrop-blur">
